...
})({"4bjwE":[function(require,module,exports) {
...
var _skillsIconsSvg = require("./skills_icons.svg");
var _skillsIconsSvgDefault = parcelHelpers.interopDefault(_skillsIconsSvg);
var _fiservSvg = require("../img/fiserv.svg");
var _fiservSvgDefault = parcelHelpers.interopDefault(_fiservSvg);
var _iEngineeringSvg = require("../img/iEngineering.svg");
var _iEngineeringSvgDefault = parcelHelpers.interopDefault(_iEngineeringSvg);
    ...
    entries.forEach((entry)=>{
        ...
        if (entry.isIntersecting) {
            ...
            const clearInt = setInterval(()=>{
                if (percentage >= 100) clearInterval(clearInt);
                else {
                    percentage++;
        ...
        htmlEl += `<div class="skills skills-${icons.language}">
                <span class="skill-icon">
                    <svg width="80" height="80" fill="none">
                        <use href="${0, _skillsIconsSvgDefault.default}#icon-${icons.language}"></use> 
...
const portfolio_img = [
    (0, _fiservSvgDefault.default),
    (0, _iEngineeringSvgDefault.default)
];
const exClass = [
    "ex_fiserv",
    "ex_iengineering"
...
</div> */ const addPortFolio = function() {
    let htmlEl = ``;
...
nav_linkEl.addEventListener("click", function(a) {
    ...
    findView.scrollIntoView({
        behavior: "smooth"
    });
});

},{"core-js/modules/web.immediate.js":"49tUX","./skills_icons.svg":"2HLs8","regenerator-runtime/runtime":"dXNgZ","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../img/fiserv.svg":"aW3Vz","../img/iEngineering.svg":"4DwpL"}],"49tUX":[function(require,module,exports) {
"use strict";
...
},{"aa6765693e58a0fe":"9fY7y","a68ecfcbf29c46f6":"148ka","7087588d33667af2":"l3Kyn","864edee099e8affb":"888a9","3a3a5a2cfab86f21":"lApyY","cff2c830bdea4f24":"RsFXo","58a74f00cee1ac64":"b9O3D"}],"2HLs8":[function(require,module,exports) {
module.exports = require("43422e3c09f7d90e").getBundleURL("pmi5x") + "skills_icons.c9f8dd69.svg" + "?" + Date.now();

},{"43422e3c09f7d90e":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"aW3Vz":[function(require,module,exports) {
module.exports = require("10fc5ca795168298").getBundleURL("pmi5x") + "fiserv.76b65b59.svg" + "?" + Date.now();

},{"10fc5ca795168298":"lgJ39"}],"4DwpL":[function(require,module,exports) {
module.exports = require("bf532fa42669cfd1").getBundleURL("pmi5x") + "iEngineering.922c620a.svg" + "?" + Date.now();

},{"bf532fa42669cfd1":"lgJ39"}]},["4bjwE","2OpUZ"], "2OpUZ", "parcelRequireeb33")
